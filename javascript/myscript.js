...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "có điều bất ngờ";
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Gửi Ngân';
document.querySelector('.Description .modal-body').innerHTML = 'i just wanna live this moment forever <i class="fas fa-heart"></i> ';
